...
export const updateNewMessage = text => ({ type: DISPATCH_CONSTANTS.DIALOG_PAGE.UPDATE_NEW_MESSAGE_TEXT, newText: text });

export const getUsers = users => ({ type: DISPATCH_CONSTANTS.USERS_PAGE.GET_USERS, users });
